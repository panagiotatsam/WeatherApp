...
public class Hourly {
     ...
     * @param windSpeed
     */
    public Hourly(long dt, double temp, double feelsLike, long pressure, long humidity, double dewPoint, double uvi, long clouds, long visibility, double windSpeed, long windDeg, List<Weather_> weather, double pop, Rain rain) {
        super();
        this.dt = dt;
        this.temp = temp;
	...
	public String toString() {
		return "Hourly [dt=" + dt + ", temp=" + temp + ", feelsLike=" + feelsLike + ", pressure=" + pressure
				...
				+ weather + ", pop=" + pop + ", rain=" + rain + ", additionalProperties=" + additionalProperties + "]";
	}
